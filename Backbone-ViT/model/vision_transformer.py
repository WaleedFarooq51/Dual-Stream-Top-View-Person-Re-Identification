...
class ViT(nn.Module):
    ...
    def load_param(self, model_path):
        ...
        # Print all param_dict keys (pre-trained weights)
        # print("Keys in param_dict (pre-trained weights):")
        # for k in param_dict.keys():
        #     print(k)

        # # Print all model's state_dict keys (model's current layers)
        # print("\nKeys in model's state_dict (current model layers):")
        ...
        for k, v in param_dict.items():
            ...
            try:
                ...
                # print(f"Loaded layer: {k} | Shape: {v.shape}")
            except:
                print('===========================ERROR=========================')
